...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.ViewHolder> {
    ...
    public SearchAdapter(List<SingleProduct> productList, SearchFragment fragment, Context context) {
    ...
    private void checkExistance(final SearchAdapter.ViewHolder holder, String product_id) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
    ...
    private void removeFromWishlist(final SearchAdapter.ViewHolder holder, String customer_id, String product_id) {
    ...
    @Override
    public void onViewDetachedFromWindow(SearchAdapter.ViewHolder holder) {
    ...
    public void updateList(List<SingleProduct> list) {
        fragment.textViewTotal.setText(list.size() + " products found");
    ...
    public void viewCart() {
        // Test
        final int count = new DatabaseMedicine(context).cartItemCount();
