...
public class LatestProductAdapter extends RecyclerView.Adapter<LatestProductAdapter.ViewHolder> {
    ...
    LatestProductActivity context;
    private RecyclerView recyclerView = null;
    int previousExpandedPosition = -1;
    int mExpandedPosition = -1;

    public LatestProductAdapter(List<SingleProduct> productList, LatestProductActivity context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new LatestProductAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(final LatestProductAdapter.ViewHolder holder, final int position) {
        ...
        if(product.getDiscount_price().equals("0.0000"))
        {
            ...
            holder.textViewPrice.setText(new StringBuilder("$").append(df2.format(price)));
    ...
    private void checkExistance(final LatestProductAdapter.ViewHolder holder, String product_id) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
    ...
    private void removeFromWishlist(final LatestProductAdapter.ViewHolder holder, String customer_id, String product_id) {
    ...
    @Override
    public void onViewDetachedFromWindow(LatestProductAdapter.ViewHolder holder) {
