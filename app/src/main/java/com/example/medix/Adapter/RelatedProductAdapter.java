...
public class RelatedProductAdapter extends RecyclerView.Adapter<RelatedProductAdapter.ViewHolder> {
    ...
    OverViewMedicineFragment fragment;
    Context context;
    private RecyclerView recyclerView = null;
    int previousExpandedPosition = -1;
    int mExpandedPosition = -1;

    public RelatedProductAdapter(List<SingleProduct> productList, OverViewMedicineFragment fragment, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_related_product_items, parent, false);
        return new RelatedProductAdapter.ViewHolder(v);
    }
    ...
    private void checkExistance(final RelatedProductAdapter.ViewHolder holder, String product_id) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
    ...
    private void removeFromWishlist(final RelatedProductAdapter.ViewHolder holder, String customer_id, String product_id) {
    ...
    @Override
    public void onViewDetachedFromWindow(RelatedProductAdapter.ViewHolder holder) {
    ...
    /*public void viewCart() {
        // Test
        final int count = new Database(context).cartItemCount();

        if (count > 0) {
            fragment.layoutViewCart.setVisibility(View.VISIBLE);
            ...
            *//*if (count == 1) {
            ...
            fragment.textViewPrice.setText(context.getResources().getString(R.string.currency_sign) + String.format("%.2f", total));

            fragment.layCart.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
            ...
            fragment.layoutViewCart.setVisibility(View.GONE);
        }
    }*/
}