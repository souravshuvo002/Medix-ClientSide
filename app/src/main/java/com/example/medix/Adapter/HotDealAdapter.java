...
public class HotDealAdapter extends RecyclerView.Adapter<HotDealAdapter.ViewHolder> {
    ...
    public HotDealAdapter(List<SingleProduct> productList, HomeFragment fragment, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_hot_deals_items, parent, false);
        return new HotDealAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(final HotDealAdapter.ViewHolder holder, final int position) {
    ...
    private void checkExistance(final HotDealAdapter.ViewHolder holder, String product_id) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
    ...
    private void removeFromWishlist(final HotDealAdapter.ViewHolder holder, String customer_id, String product_id) {
    ...
    @Override
    public void onViewDetachedFromWindow(HotDealAdapter.ViewHolder holder) {
