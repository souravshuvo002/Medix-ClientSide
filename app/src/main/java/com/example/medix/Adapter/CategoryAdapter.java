...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.ViewHolder> {
    ...
    private List<MainCategory> menuAdapters;
    private Context mCtx;

    public CategoryAdapter(List<MainCategory> menus, Context mCtx) {
        this.menuAdapters = menus;
        this.mCtx = mCtx;
    ...
    public void onBindViewHolder(final CategoryAdapter.ViewHolder holder, final int position) {
        final MainCategory menu = menuAdapters.get(position);
